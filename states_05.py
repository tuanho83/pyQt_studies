...
if __name__ == '__main__':
	...
	state1.assignProperty(boxProxy, 'geometry', QtCore.QRect(-400, 50, 350, 150))
	...
	state2.assignProperty(boxProxy,'geometry', QtCore.QRect(10, 50, 350, 150))
	...
	animation1SubGroup.addAnimation(QtCore.QPropertyAnimation(boxProxy, 'geometry', state1))
	...
	t2.addAnimation(QtCore.QPropertyAnimation(boxProxy, 'geometry', state2))
	...
	widgey = QtGui.QWidget()
	widgey.setLayout(centerLayout)
	widgey.show()
